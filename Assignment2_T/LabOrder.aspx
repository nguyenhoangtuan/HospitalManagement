<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LabOrder.aspx.cs" Inherits="Assignment2_T.LabOrder1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <h2 class="text-success">Lab Order Content :&nbsp;&nbsp; 
                <asp:Button ID="ChangeContent" runat="server" Text="Lab Order Detail" CssClass="btn btn-large btn-primary" OnClick="ChangeContent_Click" />
            </h2>
            ...
            <div runat="server" id="DrugCotent" class="divwell" style="display: inline-block; overflow: hidden; padding-bottom: 30px; padding-top: 10px; padding-right: 30px;">
                ...
                <div id="SearchDiv" class="divwell">
                    <asp:Button ID="AddDrugButton" runat="server" Text="Add Lab Order Detail"
                ...
                <div id="AddDrugDiv">
                    ...
                    <asp:Table ID="TableAddDrug" runat="server" GridLines="Both" Height="55px" Width="612px" CssClass="table table-bordered">
                        ...
                        <asp:TableRow ID="TableRow1" runat="server">
                            <asp:TableHeaderCell>Lab Order ID </asp:TableHeaderCell>
                            <asp:TableHeaderCell>
                        ...
                        <asp:TableRow ID="TableRow2" runat="server">
                            <asp:TableHeaderCell>Medical Service ID </asp:TableHeaderCell>
                            <asp:TableHeaderCell>
        ...
        <contenttemplate>--%>
                ...
                <asp:GridView ID="GridDrug" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ID"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="LabOrderID" HeaderText="LabOrderID" SortExpression="LabOrderID" />
                        <asp:BoundField DataField="MedicalServiceID" HeaderText="MedicalServiceID" SortExpression="MedicalServiceID" />
                ...
                <asp:LinqDataSource ID="LinqDataSourceDrug" runat="server" ContextTypeName="Assignment2_T.DataBaseAllDataContext"
                    EnableDelete="True" EnableInsert="True" EnableUpdate="True" EntityTypeName="" TableName="LabOrderDetails" OnSelecting="LinqDataSourceDrug_Selecting">
                </asp:LinqDataSource>
            </div>
            ...
            <div runat="server" id="DetalItem" class="divwell"
                ...
                <asp:FormView ID="FormView1" runat="server" DataSourceID="LinqDataSource2">
                    <EditItemTemplate>
                        ...
                        <br />
                        MedicalServiceID:
                        <asp:TextBox ID="MedicalServiceIDTextBox" runat="server" Text='<%# Bind("MedicalServiceID") %>' />
                        <br />
                    ...
                    <ItemTemplate>
                        ...
                        <br />
                        MedicalServiceID:
                        <asp:Label ID="MedicalServiceIDLabel" runat="server" Text='<%# Bind("MedicalServiceID") %>' />
                        <br />
                    </ItemTemplate>
                </asp:FormView>

                <asp:LinqDataSource ID="LinqDataSource2" runat="server" ContextTypeName="Assignment2_T.DataBaseAllDataContext" EntityTypeName="" Select="new (ID, Result, LabOrderID, MedicalServiceID)" TableName="LabOrderDetails" Where="ID == @ID">
                    <WhereParameters>
            ...
            <div runat="server" id="DrugCotentG" class="divwell" style="display: inline-block; overflow: hidden; padding-bottom: 30px; padding-top: 10px; padding-right: 30px;">
                ...
                <div id="SearchDivG" class="divwell">
                    <asp:Button ID="AddDrugButtonG" runat="server" Text="Add Lab Order"
                ...
                <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="Assignment2_T.DataBaseAllDataContext"
                    ...
                    TableName="LabOrders" OnSelecting="LinqDataSourceDrug_SelectingG">
                </asp:LinqDataSource>
