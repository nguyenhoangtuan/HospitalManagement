<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Patient.aspx.cs" Inherits="Assignment2_T.Patient1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <h2 class="text-success">Patient Content :</h2>
            ...
            <div runat="server" id="DrugCotent" class="divwell" style="display: inline-block; overflow: hidden; padding-bottom: 30px; padding-top: 10px; padding-right: 30px;">
                ...
                <div id="SearchDiv" class="divwell">
                    <asp:Button ID="AddDrugButton" runat="server" Text="Add Patient"
                ...
                <div id="AddDrugDiv">
                    <asp:Table ID="TableAddDrug" runat="server" GridLines="Both" Height="55px" Width="612px" CssClass="table table-bordered">
                        ...
                        <asp:TableRow ID="TableRow6" runat="server">
                            ...
                            <asp:TableHeaderCell>
                                <asp:Button ID="AddNewDrug" runat="server" ValidationGroup="group1" CausesValidation="true" Text="Add Patient To Database" OnClick="AddNewDrug_Click" />
                            </asp:TableHeaderCell>
                        </asp:TableRow>
                    </asp:Table>
                </div>
        ...
        <contenttemplate>--%>
                    ...
                    <Columns>
                        <asp:TemplateField ShowHeader="False">
                            ...
                            <ItemTemplate>
                                ...
                                &nbsp;<asp:LinkButton ID="VisitPatient" CssClass="btn btn-info" runat="server" CausesValidation="False" OnClick="VisitPatient_Click" Text="Visit"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:LinqDataSource ID="LinqDataSource" runat="server" ContextTypeName="Assignment2_T.DataBaseAllDataContext"
                     ...
                     TableName="Patients" OnSelecting="LinqDataSourceDrug_Selecting">
                </asp:LinqDataSource>
            ...
            <div runat="server" id="DetalItem" class="divwell"
                ...
                <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="Assignment2_T.DataBaseAllDataContext"
                     EntityTypeName="" Select="new (ID, Name, Address, Gender, DoB)" TableName="Patients" Where="ID == @ID">
                    <WhereParameters>
