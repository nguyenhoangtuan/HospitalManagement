<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ICD.aspx.cs" Inherits="Assignment2_T.ICD1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <h2 class="text-success">ICD Content :&nbsp;&nbsp; 
                <asp:Button ID="ChangeContent" runat="server" Text="ICD" CssClass="btn btn-large btn-primary" OnClick="ChangeContent_Click" />
            </h2>
            ...
            <div runat="server" id="DrugCotent" class="divwell" style="display: inline-block; overflow: hidden; padding-bottom: 30px; padding-top: 10px; padding-right: 30px;">
                ...
                <div id="SearchDiv" class="divwell">
                    <asp:Button ID="AddDrugButton" runat="server" Text="Add ICD"
                ...
                <div id="AddDrugDiv">
                    ...
                    <asp:Table ID="TableAddDrug" runat="server" GridLines="Both" Height="55px" Width="612px" CssClass="table table-bordered">
                        <asp:TableRow ID="TableRow1" runat="server" CssClass=".info">
                            <asp:TableHeaderCell>ICD Name</asp:TableHeaderCell>
                            <asp:TableHeaderCell>
                        ...
                        <asp:TableRow ID="TableRow5" runat="server">
                            <asp:TableHeaderCell>ICD chapter</asp:TableHeaderCell>
                            <asp:TableHeaderCell>
                        ...
                        <asp:TableRow ID="TableRow6" runat="server">
                            ...
                            <asp:TableHeaderCell>
                                <asp:Button ID="AddNewDrug" runat="server" ValidationGroup="group1" CausesValidation="true" Text="Add ICD To Database" OnClick="AddNewDrug_Click" />
                            </asp:TableHeaderCell>
                        </asp:TableRow>
                    </asp:Table>
                </div>
        ...
        <contenttemplate>--%>
                ...
                <asp:GridView ID="GridDrug" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ID"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ICDChapter" HeaderText="ICDChapter" SortExpression="ICDChapter" />
                    </Columns>
                ...
                <asp:LinqDataSource ID="LinqDataSourceDrug" runat="server" ContextTypeName="Assignment2_T.DataBaseAllDataContext"
                    EnableDelete="True" EnableInsert="True" EnableUpdate="True" EntityTypeName="" TableName="ICDs" OnSelecting="LinqDataSourceDrug_Selecting">
                </asp:LinqDataSource>
            </div>
            ...
            <div runat="server" id="DetalItem" class="divwell"
                ...
                <asp:FormView ID="FormView1" runat="server" DataSourceID="LinqDataSource2">
                    <EditItemTemplate>
                        ...
                        <br />
                        ICDChapter:
                        <asp:TextBox ID="ICDChapterTextBox" runat="server" Text='<%# Bind("ICDChapter") %>' />
                        <br />
                        Code:
                    ...
                    <ItemTemplate >
                        ID :
                        <asp:Label ID="IDLabel" runat="server" Text='<%# Bind("ID") %>' CssClass="text-success"/>
                        <br />
                        Name :
                        <asp:Label ID="NameLabel" runat="server" Text='<%# Bind("Name") %>' CssClass="text-success"/>
                        <br />
                        ICDChapter :
                        <asp:Label ID="ICDChapterLabel" runat="server" Text='<%# Bind("ICDChapter") %>' CssClass="text-success"/>
                        <br />
                        Code :
                        <asp:Label ID="CodeLabel" runat="server" Text='<%# Bind("Code") %>' CssClass="text-success"/>
                        <br />
                    </ItemTemplate>
                </asp:FormView>

                <asp:LinqDataSource ID="LinqDataSource2" runat="server" ContextTypeName="Assignment2_T.DataBaseAllDataContext" EntityTypeName="" Select="new (ID, Name, ICDChapter, Code)" TableName="ICDs" Where="ID == @ID">
                    <WhereParameters>
            ...
            <div runat="server" id="DrugCotentG" class="divwell" style="display: inline-block; overflow: hidden; padding-bottom: 30px; padding-top: 10px; padding-right: 30px;">
                ...
                <div id="SearchDivG" class="divwell">
                    <asp:Button ID="AddDrugButtonG" runat="server" Text="Add ICD Chapter"
                ...
                <div id="AddDrugDivG">
                    <asp:Table ID="TableAddDrugG" runat="server" GridLines="Both" Height="55px" Width="612px" CssClass="table table-bordered">
                        <asp:TableRow ID="TableRow7" runat="server" CssClass=".info">
                            <asp:TableHeaderCell>ICD Chapter Name</asp:TableHeaderCell>
                            <asp:TableHeaderCell>
                        ...
                        <asp:TableRow ID="TableRow5G" runat="server">
                            <asp:TableCell> </asp:TableCell>
                            <asp:TableHeaderCell>
                                <asp:Button ID="AddNewDrugG" runat="server" ValidationGroup="group1G" CausesValidation="true" Text="Add ICD Chapter To Database" OnClick="AddNewDrug_ClickG" />
                            </asp:TableHeaderCell>
                        </asp:TableRow>
                    </asp:Table>
                </div>
                ...
                <asp:GridView ID="GridDrugG" runat="server" AutoGenerateColumns="False" DataSourceID="LinqDataSource1" EmptyDataText="There are no data records to display." AllowPaging="True" AllowSorting="True" CellPadding="4" ForeColor="#333333" GridLines="None" Width="448px" DataKeyNames="ID">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                        <asp:TemplateField ShowHeader="False">
                            ...
                            <EditItemTemplate>
                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="True" 
                                    CommandName="Update" Text="Update" CssClass="btn btn-info"></asp:LinkButton>
                                
                                <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" 
                                    CommandName="Cancel" Text="Cancel" CssClass="btn btn-info"></asp:LinkButton>
                            </EditItemTemplate>
                            ...
                            <ItemTemplate>
                                ...
                                &nbsp;<asp:LinkButton ID="LinkButton3" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" CssClass="btn btn-info"></asp:LinkButton>
                ...
                <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="Assignment2_T.DataBaseAllDataContext"
                     EnableDelete="True" EnableInsert="True" EnableUpdate="True" EntityTypeName="" TableName="ICDChapters" OnSelecting="LinqDataSourceDrug_SelectingG">
                </asp:LinqDataSource>
